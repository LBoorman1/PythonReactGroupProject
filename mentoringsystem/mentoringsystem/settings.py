"""
Django settings for mentoringsystem project.
...
SECRET_KEY = 'django-insecure-^1gks7ongj*c1ylk+!#e*6dx2f$=m_^%*m=_3s&%nt_oq_p#95'
...
WSGI_APPLICATION = 'mentoringsystem.wsgi.application'
